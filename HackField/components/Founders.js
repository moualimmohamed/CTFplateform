    ...
    <Container>
      <div className="grid gap-10 lg:grid-cols-2 xl:grid-cols-4">
        <div className="lg:col-span-2 xl:col-auto">
          <div className="flex flex-col justify-between w-full h-full bg-gray-100 px-14 rounded-2xl py-14 dark:bg-trueGray-800">
            <p className="text-2xl leading-normal ">
              WLah o Ndarbek Mayl9aw lik <Mark>Dwa</Mark>.
               
            </p>

            <Avatar
              image={userOneImg}
              name="Moualim Mohamed"
        ...
        <div className="">
          <div className="flex flex-col justify-between w-full h-full bg-gray-100 px-14 rounded-2xl py-14 dark:bg-trueGray-800">
            <p className="text-2xl leading-normal ">
            Gol Panini! ila validiti had semestre aji  <Mark> 7w***i</Mark>
            </p>
        ...
        <div className="">
          <div className="flex flex-col justify-between w-full h-full bg-gray-100 px-14 rounded-2xl py-14 dark:bg-trueGray-800">
            <p className="text-2xl leading-normal ">
              Je m'appelle MR. <Mark>Victor Hugo</Mark> Mon petit chouchou d'amour.
            </p>

            <Avatar
              image={userThreeImg}
              name="Lamtigui Yousra"
              title="CyberSecurity Engineer"
            />
          </div>
        </div>
        <div className="">
          <div className="flex flex-col justify-between w-full h-full bg-gray-100 px-14 rounded-2xl py-14 dark:bg-trueGray-800">
            <p className="text-2xl leading-normal ">
              Kay3ti lah <Mark>Se7a</Mark> gha li Ma3ndo <Mark>Drass!</Mark>
            </p>

            <Avatar
              image={userFourImg}
              name="El Merzouki Amine"
              title="CyberSecurity Engineer"
            />
          </div>
        </div>
...
function Avatar(props) {
  return (
    <div>
      ...
      {/* <div className="flex items-center mt-5 space-x-5 text-teal-400 dark:text-white">
              <a
